...
import { submitResult } from "../services/submitResultService";
...
export default function PredictionForm() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const data = await submitResult(season, round, qualifyingWinner, raceTopThree);
      setMessage(`✅ Result submitted! ID: ${data._id}`);
    } catch (err) {
      setMessage(err.message || "❌ Failed to submit result");
    }
  };
